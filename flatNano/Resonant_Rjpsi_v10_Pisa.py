...
for dataset in [args.data,args.mc_mu,args.mc_tau,args.mc_bc,args.mc_hb,args.mc_onia,args.mc_gen]: 
    ...
    for flag in flag_names:
        for channel in channels:
            if channel == 'BTo3Mu':
                final_dfs_mmm[flag].to_root('dataframes_local/'+name[1]+'_'+flag+adj+'.root', key=channel)
            elif (channel == 'BTo2MuP'):
                final_dfs_pmm[flag].to_root('dataframes_local/'+name[1]+'_'+flag+adj+'.root', key=channel, mode = 'a')
            elif (channel == 'BTo2MuK'):
                final_dfs_kmm[flag].to_root('dataframes_local/'+name[1]+'_'+flag+adj+'.root', key=channel, mode = 'a')
            elif (channel == 'BTo2Mu3P'):
                final_dfs_2m3p[flag].to_root('dataframes_local/'+name[1]+'_'+flag+adj+'.root', key=channel, mode = 'a')
        print("Saved file dataframes_local/"+ name[1]+'_'+flag+adj+'.root')
