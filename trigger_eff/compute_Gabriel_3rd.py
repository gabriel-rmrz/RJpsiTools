...
outdir = "plots_doubleMu4_3_jpsi_3rd_20230704" 
...
def main():
  ...
  binning = {
      ...
      'mu1pt': [5.0, 5.5, 6.0, 7.0, 8.0, 10.0, 15.0, 20.0, 40.0],
      'mu2pt': [4.0, 4.5, 5, 5.5, 5.75, 6.0, 8.0, 10.0, 15.0, 20.0, 40.0],
      'Bpt': [5.0, 5.5, 6.0, 8.0, 10.0, 15.0, 20.0, 30.0, 40.0],
      'kpt': [4,4.5,5.0, 5.5, 6.0, 8.0, 10.0, 15.0, 20.0, 30.0],
      ...
      'jpsi_mass': [ 2.9, 3.0, 3.05, 3.1, 3.15, 3.2, 3.3],
...
#  ntuples_dir = "/pnfs/psi.ch/cms/trivcat/store/user/cgalloni/dataframes_2023Mar12/" plots_doubleMu4_3_jpsi
  ...
  #ntuples_dir = "/pnfs/psi.ch/cms/trivcat/store/user/cgalloni/dataframes_2023Jun21/" 
